using EdabitCodePractice.Challenges.Edabit.EasyCodeChallenges;
using EdabitCodePractice.Challenges.Edabit.VeryEasyCodeChallenges;

namespace EdabitCodePractice.ConsoleDisplayLogic
{
    internal class EdabitSolutionsDisplay
    {
        public static void EdabitSolutions()
        {
            Console.WriteLine("Which level of difficulty of Edabit code challenges would you like to see?\n");
            Console.WriteLine("1. Very Easy Code Challenges");
            Console.WriteLine("2. Easy Code Challenges");
            Console.WriteLine("3. Medium Code Challenges");
            Console.WriteLine("4. Hard Code Challenges");
            Console.WriteLine("5. Very Hard Code Challenges");
            Console.WriteLine("6. Expert Code Challenges\n");

            int edabitChoice;
            while (true)
            {
                Console.Write("Enter your choice (1, 2, 3, 4, 5 or 6): ");
                if (int.TryParse(Console.ReadLine(), out edabitChoice) &&
                    (edabitChoice == 1 || edabitChoice == 2 || edabitChoice == 3 ||
                    edabitChoice == 4 || edabitChoice == 5 || edabitChoice == 6))
                {
                    break;
                }
                else
                {
                    Console.WriteLine("Invalid choice. Please enter number from 1 - 6.");
                }
            }

            // Very Easy Code Challenges
            if (edabitChoice == 1)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each very easy code challenge.\n");
            ...
            // Easy Code Challenges
            if (edabitChoice == 2)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each easy code challenge.\n");
            ...
            if (edabitChoice == 3)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each medium code challenge.\n");
            }

            // Hard Code Challenges
            if (edabitChoice == 4)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each hard code challenge.\n");
            }

            // Very Hard Code Challenges
            if (edabitChoice == 5)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each very hard code challenge.\n");
            }

            // Expert Code Challenges
            if (edabitChoice == 6)
            {
                Console.WriteLine("\nHello, World!\n\nBelow are the results of each expert code challenge.\n");
            }
        }
    }
}
